            ...
            <div class="home-slide-cover mt-30">
                <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                    <div class="single-hero-slider single-animation-wrap"
                        style="background-image: url({{ asset('frontend/imgs/slider/slider-1.png') }})">
            ...
            <div class="carausel-10-columns-cover position-relative">
                <div class="carausel-10-columns" id="carausel-10-columns">
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-13.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-12.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-11.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-9.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-3.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-14 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-1.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-2.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-4.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-5.png') }}"
                                    alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href="shop-grid-right.html"><img
                                    src="{{ asset('frontend/imgs/shop/cat-14.png') }}"
                                    alt="" /></a>
                        </figure>
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-1-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-1-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                ...
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-5-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-6-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-6-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-7-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-7-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-8-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-8-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-9-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-9-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-10-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-12-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-12-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-13-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-13-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-14-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-14-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-15-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-15-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-16-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-16-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('frontend/imgs/shop/product-11-1.jpg') }}"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('frontend/imgs/shop/product-11-2.jpg') }}"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                    ...
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="vendor-details-1.html">
                                <img class="default-img"
                                    src="{{ asset('frontend/imgs/vendor/vendor-1.png') }}"
                                    alt="" />
                            </a>
                        </div>
                        <div class="product-badges product-badges-position product-badges-mrg">
                    ...
                    <div class="vendor-content-wrap">
                        ...
                        <div class="vendor-info mb-30">
                            <ul class="contact-infor text-muted">
                                ...
                                <li><img src="{{ asset('frontend/imgs/theme/icons/icon-contact.svg') }}"
                ...
                <div class="vendor-wrap mb-40">
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="vendor-details-1.html">
                                <img class="default-img"
                                    src="{{ asset('frontend/imgs/vendor/vendor-2.png') }}"
                                    alt="" />
                            </a>
                        </div>
                        <div class="product-badges product-badges-position product-badges-mrg">
                ...
                <div class="vendor-wrap mb-40">
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="vendor-details-1.html">
                                <img class="default-img"
                                    src="{{ asset('frontend/imgs/vendor/vendor-3.png') }}"
                                    alt="" />
                            </a>
                        </div>
                        <div class="product-badges product-badges-position product-badges-mrg">
                ...
                <div class="vendor-wrap mb-40">
                    <div class="vendor-img-action-wrap">
                        <div class="vendor-img">
                            <a href="vendor-details-1.html">
                                <img class="default-img"
                                    src="{{ asset('frontend/imgs/vendor/vendor-4.png') }}"
                                    alt="" />
                            </a>
                        </div>
                        <div class="product-badges product-badges-position product-badges-mrg">
