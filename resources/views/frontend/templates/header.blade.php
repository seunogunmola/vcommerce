            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{ route('home') }}"><img src="{{ asset(env('APP_LOGO')) }}" alt="logo"  /></a>
                    </div>
                                    ...
                                    @auth
                                        ...
                                        <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="{{ route('user.logout') }}" onclick="return confirm('Are You Sure?')"><i class="fi fi-rs-sign-out mr-10"></i>Logout</a>
                                                </li>
                                            </ul>
                                        </div>
                                    @else                                    
